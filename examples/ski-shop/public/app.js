...
async function init() {
    ...
    try {
        ...
        if (devRes.ok) {
            ...
            state.deviceProfile = { id: state.deviceId, browser: navigator.userAgent, deviceName: 'Current Session' };
        }
...
function setupTooltips() {
    ...
    attach('displayDevice', () => state.deviceProfile || { id: state.deviceId, note: "Not tracked yet" });
